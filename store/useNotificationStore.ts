...
const INITIAL_NOTIFICATIONS: NotificationItem[] = [
  {
    ...
    message: 'Netflix Premium ($19.99) will renew in 7 days on Aug 15. Tap to review billing details.',
  ...
  },
  {
    ...
    message: 'Attention! "Sync Mobile App Database Schema" is past due date.',
    type: 'overdue_task',
    is_read: false,
    target_type: 'task',
    target_id: 'task-2',
